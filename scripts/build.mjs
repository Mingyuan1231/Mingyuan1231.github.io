...
await page('/', 'Mingyuan Wang | Quantum Information · UMass Amherst',
  ...
  `<section class="hero"><div><p class="eyebrow">Quantum information · UMass Amherst</p><h1>Mingyuan Wang <span class="chinese" lang="zh">王明元</span></h1><p class="position">Physics PhD candidate · Krastanov Lab</p><p class="intro">I develop methods for <strong>multipartite entanglement</strong>, <strong>quantum networks</strong>, and <strong>quantum error correction</strong>. I use stabilizer and Clifford methods, graph structure, and optimization to design quantum resources and circuits under noise and finite-resource constraints.</p><p>I am a Physics PhD candidate at the University of Massachusetts Amherst, working with <a href="https://lab.krastanov.org/">Stefan Krastanov</a> in the Center for Quantum Networks. My background also includes experimental condensed-matter physics and astronomical instrumentation.</p><div class="links"><a class="button" href="/research/">Explore my research</a><a href="mailto:${config.email}">Email</a><a href="${config.github}">GitHub</a></div></div><aside class="portrait-panel"><img class="portrait" src="/assets/mingyuan-wang.jpg" alt="Mingyuan Wang" width="248" height="302"><div class="portrait-note"><strong>University of Massachusetts Amherst</strong>Department of Physics<br>Amherst, Massachusetts</div></aside></section>
  ...
  <section class="section"><div class="section-head"><h2>Selected publications</h2><a href="/publications/">View publications →</a></div>${paperList(papers.filter(p => p.featured))}</section>
  <section class="section"><div class="section-head"><h2>Current research</h2><a href="/research/">Research directions →</a></div><div class="lower-grid current-projects"><article><p class="project-status">Manuscript in preparation</p><h3><a href="/research/sequence-control/">Sequence control & PairMoment</a></h3><p>Choosing the order of partial-distillation steps under correlated noise, using a reduced model that tracks single-vertex errors and pair correlations.</p></article><article><p class="project-status">Ongoing research</p><h3><a href="/research/graph-state-synthesis/">Task-aware graph-state synthesis</a></h3><p>Studying how noisy resource states and fusion plans shape the error distributions seen by downstream quantum protocols.</p></article></div></section>
