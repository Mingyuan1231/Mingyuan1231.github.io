...
await page('/', 'Mingyuan Wang | Quantum Information · UMass Amherst',
  ...
  `<section class="hero"><div><p class="eyebrow">Quantum information</p><h1>Mingyuan Wang <span class="chinese" lang="zh">王明元</span></h1><p class="position">Physics PhD candidate · UMass Amherst</p><p class="intro">I study <strong>entanglement distillation</strong> and the design of quantum resources for <strong>quantum networks</strong> and <strong>quantum error correction</strong>.</p><p>I work with <a href="https://lab.krastanov.org/">Stefan Krastanov</a> in the Center for Quantum Networks, using graph structure and optimization to develop multipartite quantum protocols under noise.</p><div class="links"><a class="button" href="/research/">Research</a><a href="/cv/">CV & contact</a><a href="mailto:${config.email}">Email</a></div></div><aside class="portrait-panel"><img class="portrait" src="/assets/mingyuan-wang.jpg" alt="Mingyuan Wang" width="248" height="302"></aside></section>
