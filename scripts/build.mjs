...
<footer class="site-footer"><div class="wrap footer-inner"><p>Mingyuan Wang · University of Massachusetts Amherst</p><p><a href="mailto:${config.email}">Email</a> &nbsp; / &nbsp; <a href="${config.github}">GitHub</a> &nbsp; / &nbsp; <a href="${esc(config.scholar)}">Scholar</a> &nbsp; / &nbsp; <a href="${config.orcid}">ORCID</a></p></div></footer></body></html>\n`;
}
...
for (const p of papers) {
  ...
  const abstract = p.abstract ? `<h2 id="abstract">Abstract</h2><p class="abstract">${esc(p.abstract)}</p>` : `<h2 id="summary">Research summary</h2><p>${esc(p.overview)}</p>`;
